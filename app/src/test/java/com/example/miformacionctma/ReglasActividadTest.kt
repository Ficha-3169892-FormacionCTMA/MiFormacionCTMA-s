...
class ReglasActividadTest {
    ...
    @Test
    fun `HU-16 CP-03 Validar progreso fuera de rango`() {
    ...
    @Test
    fun `HU-16 CP-03 Validar fecha anterior a hoy`() {
